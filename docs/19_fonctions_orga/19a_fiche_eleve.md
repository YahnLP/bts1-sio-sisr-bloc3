...
### Document 1 – Les fonctions oxygénées
...
**Propriété :**
- Forme des **liaisons hydrogène** avec l'eau → **hydrophile** (soluble dans l'eau)
- Hydratant (retient l'eau)
- Peut être antioxydant (tocophérol)
...
**Propriété :**
- **Ne forme PAS de liaisons H** (pas de H lié à O)
- Moins hydrophile qu'un alcool
- Solvant, conservateur
...
**Propriété :**
- Réactif (le C=O peut réagir)
- Peut être irritant (aldéhyde formique = formaldéhyde)
...
**Propriété :**
- **Acide** (donne des H⁺, abaisse le pH)
- Forme des liaisons H → hydrophile
- Exfoliant (AHA, BHA)
...
**Propriété :**
- **Lipophile** (soluble dans l'huile)
- Émollient
- Peut être hydrolysé (réaction inverse : ester → acide + alcool)
...
### Tableau récapitulatif des fonctions oxygénées
...
### Document 2 – Les fonctions azotées, soufrées et autres

#### Fonctions azotées (contiennent de l'azote, N)
...
**Propriété :**
- **Basique** (capte des H⁺, augmente le pH)
- Forme des liaisons H
- Ajustement du pH, émulsifiant

---

##### 2. Ammonium quaternaire
...
**Propriété :**
- **Cationique** (chargé +)
- Conservateur, conditionneur capillaire (attire les cheveux chargés –)

---

##### 3. Amide (liaison peptidique)
...
**Propriété :**
- **Liaison peptidique** : relie les acides aminés
- Forme des liaisons H → stabilise les protéines
- Actif anti-âge (stimule collagène)

---

#### Fonctions soufrées (contiennent du soufre, S)
...
**Propriété :**
- Forme des **ponts disulfure** (–S–S–) en s'oxydant
- Stabilise la structure de la kératine (cheveux, ongles)
...
**Propriété :**
- Moins réactif que le thiol
- Présent dans certaines protéines
...
**Propriété :**
- **Oxydant puissant** (libère O₂)
- Décoloration (cheveux), conservateur
...
### Document 3 – Liaisons hydrogène et stabilisation des structures

#### Qu'est-ce qu'une liaison hydrogène ?

Une **liaison hydrogène** (ou pont hydrogène) est une **interaction faible** entre :
- Un atome d'**hydrogène** (lié à O, N ou F)
- Un autre atome **électronégatif** (O, N, F)
...
#### Quelles fonctions forment des liaisons H ?
...
#### Rôle des liaisons H en cosmétique
...
## 🧪 Travail 1 – Reconnaître les fonctions oxygénées (15 min)

> 🎯 **Compétence E2 : Mobiliser, Analyser**

À partir du **Document 1** et de la **Fiche méthode 08** :

### 1.1 – Identifier les fonctions
...
## 🔍 Travail 2 – Reconnaître les fonctions azotées et soufrées (15 min)

> 🎯 **Compétence E2 : Analyser, Interpréter**

À partir du **Document 2** et de la **Fiche méthode 08** :

### 2.1 – Identifier les fonctions
...
## 💧 Travail 3 – Liaisons hydrogène et stabilisation (10 min)

> 🎯 **Compétence E2 : Interpréter, Argumenter**

À partir du **Document 3** :

### 3.1 – Identifier les fonctions formant des liaisons H
...
### 3.3 – Rôle des liaisons H

Expliquez en 3 à 5 lignes pourquoi les liaisons H sont importantes pour :
1. La solubilité des ingrédients dans l'eau
2. La stabilisation des protéines (collagène, kératine)

<br><br><br><br>

---

## 🧴 Travail 4 – Analyser une liste INCI (15 min)
...
### 4.1 – Identifier les fonctions

Complétez le tableau :

| Ingrédient INCI | Fonction(s) chimique(s) | Propriété cosmétique |
|-----------------|:-----------------------:|:--------------------:|
| **Glycerin** | _______ | _______ |
| **Sodium Hyaluronate** | _______ | _______ |
| **Palmitoyl Tripeptide-1** | _______ | _______ |
| **Tocopherol** | _______ | _______ |
| **Phenoxyethanol** | _______ | _______ |
